...
Plyr.propTypes = {
  ...
  listeners: _propTypes2.default.shape({
    seek: _propTypes2.default.func,
    play: _propTypes2.default.func,
    pause: _propTypes2.default.func,
    restart: _propTypes2.default.func,
    rewind: _propTypes2.default.func,
    fastForward: _propTypes2.default.func,
    mute: _propTypes2.default.func,
    volume: _propTypes2.default.func,
    captions: _propTypes2.default.func,
    fullscreen: _propTypes2.default.func,
    pip: _propTypes2.default.func,
    airplay: _propTypes2.default.func,
    speed: _propTypes2.default.func,
    quality: _propTypes2.default.func,
    loop: _propTypes2.default.func,
    language: _propTypes2.default.func
  }),
